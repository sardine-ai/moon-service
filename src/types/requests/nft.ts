...
export class BuyNftParams extends BaseRequest {
  ...
  @IsDefined()
  @Expose()
  @IsValidEvmAddress({message: "RecipientAddress address must be a valid EVM Address"})
  recipientAddress: string;

  @IsDefined()
  @Expose()
  @IsIn(VALID_PLATFORM, {message: `Platform must be one of ${VALID_PLATFORM.toString()}`})
  platform: string;
