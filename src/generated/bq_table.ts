...
export const BigQueryMessageOptions = {
  encode(message: BigQueryMessageOptions, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BigQueryMessageOptions {
  ...
  fromJSON(object: any): BigQueryMessageOptions {
    return {
      ...
      useJsonNames: isSet(object.useJsonNames) ? Boolean(object.useJsonNames) : false,
    };
  },
  ...
  toJSON(message: BigQueryMessageOptions): unknown {
    ...
    message.useJsonNames !== undefined && (obj.useJsonNames = message.useJsonNames);
    return obj;
  },
