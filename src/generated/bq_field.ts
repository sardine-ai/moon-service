...
function createBaseBigQueryFieldOptions(): BigQueryFieldOptions {
  return { require: false, typeOverride: "", ignore: false, description: "", name: "" };
}

export const BigQueryFieldOptions = {
  encode(message: BigQueryFieldOptions, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BigQueryFieldOptions {
  ...
  fromJSON(object: any): BigQueryFieldOptions {
    return {
      ...
      typeOverride: isSet(object.typeOverride) ? String(object.typeOverride) : "",
  ...
  toJSON(message: BigQueryFieldOptions): unknown {
    ...
    message.typeOverride !== undefined && (obj.typeOverride = message.typeOverride);
