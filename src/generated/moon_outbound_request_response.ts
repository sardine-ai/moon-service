...
export const MoonOutboundRequestResponse = {
  encode(message: MoonOutboundRequestResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.url !== "") {
    ...
    Object.entries(message.requestParams).forEach(([key, value]) => {
      MoonOutboundRequestResponse_RequestParamsEntry.encode({ key: key as any, value }, writer.uint32(26).fork())
        .ldelim();
    });
    if (message.clientId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MoonOutboundRequestResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          const entry3 = MoonOutboundRequestResponse_RequestParamsEntry.decode(reader, reader.uint32());
  ...
  fromJSON(object: any): MoonOutboundRequestResponse {
    return {
      ...
      requestParams: isObject(object.requestParams)
        ? Object.entries(object.requestParams).reduce<{ [key: string]: string }>((acc, [key, value]) => {
      ...
      latencyMillis: isSet(object.latencyMillis) ? Number(object.latencyMillis) : 0,
  ...
  toJSON(message: MoonOutboundRequestResponse): unknown {
    ...
    message.latencyMillis !== undefined && (obj.latencyMillis = Math.round(message.latencyMillis));
    message.serviceName !== undefined && (obj.serviceName = message.serviceName);
    message.requestId !== undefined && (obj.requestId = message.requestId);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<MoonOutboundRequestResponse>, I>>(object: I): MoonOutboundRequestResponse {
    const message = createBaseMoonOutboundRequestResponse();
    message.url = object.url ?? "";
    message.method = object.method ?? "";
    message.requestParams = Object.entries(object.requestParams ?? {}).reduce<{ [key: string]: string }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
          acc[key] = String(value);
        }
...
export const MoonOutboundRequestResponse_RequestParamsEntry = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MoonOutboundRequestResponse_RequestParamsEntry {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<MoonOutboundRequestResponse_RequestParamsEntry>, I>>(
    object: I,
